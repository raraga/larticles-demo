...
export default {
    ...
    // Think about created as the same thing as ComponentDidMount().
    // It will run once the component is made.
    created() {
        this.fetchArticles();
    },
    methods: {
        fetchArticles(page_url) {
            ...
            fetch(page_url)
                .then(res => res.json())
                .then(res => {
                    // Pushing back up to our articles array within our data function.
